...
public record AdminAccountDto(
    ...
    public static AdminAccountDto of(String userId,
                                     ...
                                     String nickname,
                                     String memo) {
        return AdminAccountDto.of(userId, userPassword, roleTypes, email, nickname,
    ...
    public static AdminAccountDto of(String userId,
                                     ...
                                     LocalDateTime modifiedAt,
                                     String modifiedBy) {
        return new AdminAccountDto(userId, userPassword, roleTypes, email, nickname,
                memo, createdAt, createdBy, modifiedAt, modifiedBy);
    }
