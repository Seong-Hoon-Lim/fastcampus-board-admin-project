...
import com.fastcampus.adminproject.dto.response.ArticleCommentClientResponse;
...
class ArticleCommentManagementServiceTest {
    ...
    class RestTemplateTest {
        ...
        void givenCommentId_whenCallingCommentApi_thenReturnsComment() throws Exception {
            ...
            ArticleCommentDto expectedComment = createArticleCommentDto("댓글");
            server
                    .expect(requestTo(projectProperties.board().url() + "/api/articleComments/"
                            + articleCommentId + "?projection=withUserAccount"))
                    .andRespond(withSuccess(
