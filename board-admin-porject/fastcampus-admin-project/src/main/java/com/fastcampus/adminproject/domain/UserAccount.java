package com.fastcampus.adminproject.domain;

import com.fastcampus.adminproject.domain.constant.RoleType;
import com.fastcampus.adminproject.domain.converter.RoleTypesConverter;
...
public class UserAccount extends AuditingFields {
    ...
    public UserAccount(String userId, String userPassword, Set<RoleType> roleTypes, String email, String nickname, String memo, String createdBy) {
        this.userId = userId;
